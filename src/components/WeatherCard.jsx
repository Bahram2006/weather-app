...
export default function WeatherCard({ weather, loading = false }) {
  if (loading && !weather) {
    return (
      <div className="rounded-2xl border border-white/30 bg-white/60 p-8 shadow-lg hover:shadow-2xl backdrop-blur dark:border-white/10 dark:bg-white/10 transition-all duration-300 hover:scale-105">
